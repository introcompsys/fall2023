...
(base) brownsarahm@fa23-kwl-brownsarahm $ ssh-keygen -f ~/seawulf -t rsa -b 1024
...
|...+&o* +B. .    |
|oo=**X+++=+.     |
(base) brownsarahm@fa23-kwl-brownsarahm $ ssh-copy-id -i ~/seawulf brownsarahm@seawulf.uri.edu
...
(base) brownsarahm@systems $ ssh -i ~/.ssh/seawulf brownsarah@seawulf.uri.edu
brownsarah@seawulf.uri.edu's password: 

(base) brownsarahm@systems $ ssh -i ~/seawulf brownsarah@seawulf.uri.edu
brownsarah@seawulf.uri.edu's password: 
...
(base) brownsarahm@systems $ ls ~ |grep seawful
(base) brownsarahm@systems $ ls ~ |grep seawulf
seawulf
seawulf.pub
(base) brownsarahm@systems $ ssh -i ~/seawulf brownsarahm@seawulf.uri.edu
